	...
	<div class="onemachinecon">
		...
		<div class="container-right ">
			<div class="container-right-top ">
				<WorkerNotesTable></WorkerNotesTable>
				<WorkerInfor></WorkerInfor>
			</div>
			<div class="container-right-bottom ">
				<StatChart :statchartheader="statchartheader"></StatChart>
...
<script>
	import WorkerNotesTable from './workernotes/WorkerNotesTable.vue'
	import WorkerInfor from './workernotes/WorkerInfor.vue'
	...
	export default {
		...
		data() {
			return {
				statchartheader:"A003异常历史记录",
				PieHeaderDay: "A003异常计数统计",
